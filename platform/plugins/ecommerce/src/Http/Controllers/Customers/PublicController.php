...
class PublicController extends BaseController
{
    ...
    public function getEditAccount()
    {
        ...
        return Theme::scope('ecommerce.customers.edit-account', compact('form'), 'plugins/ecommerce::themes.customers.edit-account')
            ->render();
    }
    ...
    public function postChangePassword(UpdatePasswordRequest $request)
    {
        ...
        ChangePasswordForm::createFromModel($user)->saving(function (ChangePasswordForm $form) {
            $model = $form->getModel();
            $request = $form->getRequest();
    ...
    public function getDownload(int|string $id, Request $request)
    {
        ...
        $fileName = Storage::disk('local')->path($zipName);
        $zip = new Zipper();
        $zip->make($fileName);
