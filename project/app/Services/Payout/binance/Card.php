...
class Card
{
    public static function payouts($payout)
    {
        ...
        $response = $card->payoutBinanceCurlRequestWithHeaders($url, $API_Key, 'POST');
    ...
    public static function getStatus()
    {
        ...
        $response = $card->payoutBinanceCurlRequestWithHeaders($url, $API_Key, 'GET');
        $result = json_decode($response);
    ...
    public static function payoutBinanceCurlRequestWithHeaders($url, $api_key, $request)
    {
        $curl = curl_init();
