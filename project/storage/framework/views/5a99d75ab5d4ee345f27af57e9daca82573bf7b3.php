                                ...
                                <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-code="<?php echo e($method->code); ?>">
                                            ...
                                            <div class="d-flex no-block align-items-center">
                                                <div class="mr-3">
                                                    <img
                                                        ...
                                                        alt="<?php echo e($method->name); ?>" class="rounded-circle" width="45"
                                                        height="45">
                                                </div>
                                                <div class="mr-3">
                                        ...
                                        <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                            ...
                                            <?php echo $method->status == 1 ? '<span class="badge badge-light"><i class="fa fa-circle text-success font-12"></i> '.trans('Active').'</span>' : '<span class="badge badge-light"><i class="fa fa-circle text-danger font-12"></i> '.trans('Deactive').'</span>'; ?>
                                        ...
                                        <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="btn btn-sm btn-outline-<?php echo e(($method->status == 0)?'success':'danger'); ?>   btn-circle disableBtn"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\gamearena\project\resources\views/admin/payment_methods/index.blade.php ENDPATH**/ ?>