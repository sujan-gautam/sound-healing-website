                    ...
                    @forelse($funds as $key => $fund)
                        <tr>
                            ...
                            <td data-label="@lang('Username')">
                                    <a href="{{route('admin.user-edit',[$fund->id])}}">
                                                <div class="d-flex no-block align-items-center">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <span class="text-muted font-14">@lang(optional($fund->user)->email)</span>
                                                    </div>
                                                </div>
                                            </a>
                            ...
                            <td data-label="@lang('Charge')"
                                class="text-danger">{{ $basic->currency_symbol }}{{ getAmount($fund->charge)}} </td>
