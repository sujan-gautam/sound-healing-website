                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-list ">
                            ...
                            @if(config('basic.top_up'))
                                <a href="{{ route('admin.topUpSell',$user->id) }}"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-gamepad"></i></span> @lang('Game Topup')
                                </a>
                            @endif
                            @if(config('basic.voucher'))
                                <a href="{{ route('admin.voucherSell',$user->id) }}"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-tags"></i></span> @lang('Voucher Sell')
                                </a>
                            @endif
                            @if(config('basic.gift_card'))
                                <a href="{{ route('admin.sellGiftCard',$user->id) }}"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fab fa-cc-apple-pay"></i></span> @lang('Gift Card Sell')
                                </a>
                            @endif
                            @if(config('basic.sell_post'))
                                <a href="{{ route('admin.gameSellList',['user',$user->id]) }}"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-shopping-cart"></i></span> @lang('Sell Post')
                                </a>

                                <a href="{{ route('admin.sellOffer',$user->id) }}"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-comment-dots"></i></span> @lang('Offer List')
                                </a>
                            @endif
                        </div>
                    </div>
