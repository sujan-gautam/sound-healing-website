                            ...
                            <td data-label="@lang('Status')">
                                @if($ticket->status == 0)
                                   <span class="badge badge-light">
                                        <i class="fa fa-circle text-success success  font-12"></i> @lang('Open')
                                   </span>

                                @elseif($ticket->status == 1)
                                  <span class="badge badge-light">
                                        <i class="fa fa-circle text-primary primary  font-12"></i> @lang('Answered')
                                   </span>
                                @elseif($ticket->status == 2)
                                    <span class="badge badge-light">
                                        <i class="fa fa-circle text-warning warning  font-12"></i> @lang('Customer Reply')
                                   </span>
                                @elseif($ticket->status == 3)
                                 <span class="badge badge-light">
                                        <i class="fa fa-circle text-dark dark  font-12"></i> @lang('Customer Reply')
                                   </span>
                                @endif
                            </td>
