            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach ($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                        role="tabpanel">
                        <form method="post" action="{{ route('admin.categoryStore', $language->id) }}" class="mt-4"
                            ...
                            <div class="row">
                                ...
                                @if ($loop->index == 0)
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-secondary">@lang('Thumb size') {{config('location.category.thumb')}} @lang('px')</span>
                                            @error('thumb')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-secondary">@lang('Instruction Image size') {{config('location.category.size')}} @lang('px')</span>
                                ...
                                <div class="col-sm-12 col-md-12 my-3">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote @error('instruction_text' . '.' . $language->id) is-invalid @enderror"
                                            name="instruction_text[{{ $language->id }}]" id="summernote" rows="15"
                                            value="{{ old('instruction_text' . '.' . $language->id) }}">{{ old('instruction_text' . '.' . $language->id) }}</textarea>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <select class="form-control  mb-3" name="discount_type" aria-label=".form-select-lg example">
