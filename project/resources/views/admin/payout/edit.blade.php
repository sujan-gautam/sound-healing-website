                    ...
                    <form method="post" action="{{route('admin.payout-method.update', $method->id)}}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 col-6">
                                ...
                                <input type="text" class="form-control"
                                       name="name"
                                       value="{{ old('name', $method->methodName ?? '') }}" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                           name="minimum_amount"
                                           value="{{ old('minimum_amount', round($method->min_limit, 2) ?? '') }}"
                                           required="">
                            ...
                            <div class="form-group col-md-6 col-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                           name="maximum_amount"
                                           value="{{ old('maximum_amount', round($method->max_limit, 2) ?? '') }}"
                                           required="">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            {{ $basic->currency ?? 'USD' }}
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                           name="percent_charge"
                                           value="{{ old('percent_charge', round($method->percentage_charge, 2) ?? '') }}"
                                           required="">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            %
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="image-input ">
                                    ...
                                    <img id="image_preview_container" class="preview-image"
                                         src="{{ getFile(config('location.withdraw.path').$method->logo)}}"
                                         alt="preview image">
                                </div>
                                @error('image')
                                <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="custom-switch-btn">
                                        ...
                                        <input type="checkbox" name="status" class="custom-switch-checkbox" id="status"
                                               value="0" {{($method->is_active == 0) ? 'checked':''}}>
                        ...
                        @if($method->is_automatic == 0)
                            <div class="row addedField">
                                @if($method->inputForm)
                                    @foreach ($method->inputForm as $k => $v)
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
