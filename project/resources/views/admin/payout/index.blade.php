                        ...
                        <tr>
                            <td data-label="@lang('Name')">
                                <div class="d-flex no-block align-items-center">
                                    <div class="mr-3">
                                        <img src="{{ getFile(config('location.withdraw.path').$method->logo)}}" alt="{{$method->methodName}}" class="rounded-circle" width="45" height="45">
                                    </div>
                                    <div class="mr-3">
                                        <h5 class="text-dark mb-0 font-16 font-weight-medium">{{ $method->methodName }}</h5>
                                    </div>
                            ...
                            <span
                                class="badge badge-pill badge-{{($method->is_active == 1) ?'success' : 'danger'}}">{{($method->is_active == 1) ?trans('Active') : trans('Deactive')}}</span>
                            </td>
