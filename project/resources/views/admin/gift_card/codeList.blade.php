        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card  shadow">
                    <div class="card-body">
                        <h4 class="card-title">`@lang(@optional($giftCardService->giftCard)->details->name)` @lang('Services')</h4>


                        <div class="list-group ">
                            @if($giftCardService->giftCard)
                                @foreach(optional($giftCardService->giftCard)->services as $key => $data)
                                    <a href="{{route('admin.giftCard.serviceCode',[$data->id])}}"
                                       class="list-group-item  d-flex justify-content-between @if($giftCardService->name == $data->name) active @endif"
                                       title="{{$data->name}}"
                                    >
                ...
                <div class="card shadow my-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.sampleFiles')}}" class="btn btn-sm btn-success btn-rounded"><i class="fa fa-download"></i> @lang('Sample')</a>
                        </div>

                        <form action="{{route('admin.uploadBulkGiftCardCode')}}" method="post" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card  shadow">
                    ...
                    <div class="card-body">
                        ...
                        <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                            ...
                            <tbody>
                            @forelse($giftCardServiceCode as $key => $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Gift Card')">{{$item->giftCard->name}}</td>
                                    <td data-label="@lang('Service')">{{$item->giftCardService->name}}</td>
                                        ...
                                        <div class="dropdown show dropup">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <button class="dropdown-item edit-button" data-toggle="modal"
                                                        ...
                                                        data-route="{{route('admin.giftCardServiceCodeUpdate',$item->id)}}"
                                                        data-resource="{{$item}}"
                                                >
                                                ...
                                                <a class="dropdown-item deleteBtn notiflix-confirm" href="javascript:void(0)"
                                                   ...
                                                   data-route="{{ route('admin.giftCardServiceCodeDelete', $item->id) }}"
                                                   data-toggle="modal"
                                                >
    ...
    <div class="modal fade" id="add_code" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.giftCardServiceCodeStore',[$giftCardId,$serviceId])}}" method="post">
                    @csrf
                    <div class="modal-body">
        ...
        $(document).ready(function (e) {
            ...
            $(document).on('click', '.active-yes', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.giftCardServiceCode.active') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.inactive-yes', function (e) {
                ...
                $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                    url: "{{ route('admin.giftCardServiceCode.inactive') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
            ...
            $(document).on('click', '.delete-yes', function (e) {
                ...
                $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                    url: "{{ route('admin.giftCardServiceCode.delete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
