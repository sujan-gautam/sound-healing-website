    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 justify-content-end">
                <a href="{{ route('admin.gameVoucher') }}" class="btn btn-sm  btn-primary mr-2">
            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach ($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                        role="tabpanel">
                        <form method="post" action="{{ route('admin.gameVoucherUpdate', [$id, $language->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 mb-3">
                                    ...
                                    <input type="text" name="name[{{ $language->id }}]"
                                        ...
                                        value="<?php echo old('name' . $language->id, isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->name : ''); ?>">
                                ...
                                <div class="col-sm-12 col-md-12 my-3">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote @error('details' . '.' . $language->id) is-invalid @enderror"
                                            name="details[{{ $language->id }}]" id="summernote" rows="15" value="<?php echo old('details' . $language->id, isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->details : ''); ?>">
                                            <?php echo old('details' . $language->id, isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->details : ''); ?>
                                        </textarea>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="discount_amount"
                                                   class="form-control  @error('name' . '.' . $language->id) is-invalid @enderror"
                                                   value="<?php echo old('discount_amount' . $language->id, isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->gameVoucher->discount_amount : ''); ?>">
                                            <div class="input-group-prepend">
                                                <select class="form-control mb-3" name="discount_type"
                                                        aria-label=".form-select-lg example">
                                                    <option value="0" @if (@$voucherDetails[$language->id][0]->gameVoucher->discount_type == '0') selected @endif>@lang(config('basic.currency'))
                                                    </option>
                                                    <option value="1" @if (@$voucherDetails[$language->id][0]->gameVoucher->discount_type == '1') selected @endif>
                                                       %</option>
                                                </select>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="custom-switch-btn">
                                            ...
                                            <input type="checkbox" name="discount_status" class="custom-switch-checkbox"
                                                   id="discount_status"
                                                   value="0" <?php if (@$voucherDetails[$language->id][0]->gameVoucher->discount_status == 0):echo 'checked'; endif ?> >
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="custom-switch-btn">
                                            ...
                                            <input type="checkbox" name="featured" class="custom-switch-checkbox"
                                                   id="featured"
                                                   value="0" <?php if (@$voucherDetails[$language->id][0]->gameVoucher->featured == 0):echo 'checked'; endif ?> >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="status" class="custom-switch-checkbox"
                                                       id="status"
                                                       value="0" <?php if (@$voucherDetails[$language->id][0]->gameVoucher->status == 0):echo 'checked'; endif ?> >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-input ">
                                            ...
                                            <img id="image_preview_container" class="preview-image"
                                                 src="{{ getFile(config('location.voucher.path') . (isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->gameVoucher->image : '')) }}"
                                                 alt="@lang('preview image')">
                                        </div>
                                        <span class="text-secondary">@lang('Image size') {{config('location.voucher.size')}} @lang('px')</span>
                                        @error('image')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="image-input ">
                                                ...
                                                <img id="favicon_preview_container" class="preview-image"
                                                     src="{{ getFile(config('location.voucher.path') . (isset($voucherDetails[$language->id]) ? @$voucherDetails[$language->id][0]->gameVoucher->thumb : '')) }}"
                                                     alt="preview image">
                                            </div>
                                        </div>
                                        <span class="text-secondary">@lang('Thumb size') {{config('location.voucher.thumb')}} @lang('px')</span>
                                        @error('thumb')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
