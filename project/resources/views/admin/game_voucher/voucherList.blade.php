...
@section('content')
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-3">
                <div>
                    <a href="{{ route('admin.gameVoucherCreate') }}" class="btn btn-sm btn-primary mr-2">
                                    ...
                                    <div class="dropdown show dropup">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.gameVoucherEdit', $item->id) }}">
                                            ...
                                            <a class="dropdown-item notiflix-confirm" href="javascript:void(0)"
                                                ...
                                                data-route="{{ route('admin.gameVoucherDelete', $item->id) }}"
                                                data-toggle="modal">
    ...
    <div class="modal fade" id="add_service" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.voucherServicesStore') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">@lang('Voucher') </label>
                            <select class="form-control" name="voucher_id" aria-label=".form-select-lg example" required>

                                <option value="" selected disabled>@lang('Select One')</option>
                                @foreach ($manageVoucher as $item)
                                    <option value="{{ $item->details->game_vouchers_id }}">{{ $item->details->name }}
                                    </option>
                                @endforeach
    ...
    <div class="modal fade" id="all_active" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title">@lang('Voucher Active Confirmation')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p>@lang('Are you really want to active the Voucher')</p>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="all_inactive" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title">@lang('Voucher DeActive Confirmation')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p>@lang('Are you really want to Deactive the Voucher')</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light"
                        data-dismiss="modal"><span>@lang('No')</span></button>
            ...
            <div class="modal-content ">
                ...
                <form action="" method="post" class="service-edit_route">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">@lang('Voucher') </label>
                            <select class="form-control service-game_vouchers_id" name="voucher_id" required>
                                <option value="" selected disabled>@lang('Select Voucher')</option>
                                @foreach ($manageVoucher as $item)
                                    <option value="{{ optional($item->details)->game_vouchers_id }}">
    ...
    <script>
                    ...
                    <tr>
                        ...
                        <td>
                            <button
                                      ...
                                      data-game_vouchers_id="${obj.game_vouchers_id}"
                                      data-toggle="modal"
                            ...
                            <a  href="${obj.serviceInfoRoute}" target="_blank"
                                      class="btn btn-sm btn-outline-success">@lang('Voucher Code')</a>
                        </td>
                    </tr>`;
        ...
        $(document).on('click', '.active-yes', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.gameVoucher.active') }}",
                data: {
                    strIds: strIds
                },
                datatType: 'json',
        ...
        $(document).on('click', '.inactive-yes', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.gameVoucher.inactive') }}",
                data: {
                    strIds: strIds
                },
                datatType: 'json',
        ...
        $(document).on('click', '.update_service', function() {
            ...
            $('.service-game_vouchers_id').val($(this).data('game_vouchers_id'));
