                        ...
                        <form method="post" action="{{ route('admin.update.payment.methods', $method->id) }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the payment method name')
                                    </div>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the currency')
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the currency symbol')
                                    </div>
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the convention rate')
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the minimum deposit amount')
                                    </div>
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the maximum deposit amount')
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the percentage charge')
                                    </div>
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('Please fill in the fixed charge')
                                    </div>
                            ...
                            <div class="row">
                                @foreach ($method->parameters as $key => $parameter)
                                    <div class="form-group  col-md-6 col-6">
                                        ...
                                        <div class="invalid-feedback">
                                            @lang('Please fill in the') {{ str_replace('_',' ', $key) }}
                                        </div>
                                        @if ($errors->has($key))
                                            <span class="invalid-text">
                                                {{ $errors->first($key) }}
